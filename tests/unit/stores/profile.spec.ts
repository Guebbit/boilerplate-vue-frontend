/**
 * Unit tests for the profile store's `signup`.
 *
 ...
 *
 * `signup` was the one store method that had no `imageUpload` branch while
 * `SignupRequest.imageUpload` had been declared in `openapi.yaml` and `signupWithMultipart`
 * generated for it all along.
 */
...
describe('useProfileStore.signup', () => {
    beforeEach(() => {
