...
/**
 * Runtime locale discovery — `src/infrastructure/i18n/apiDictionary.ts`.
 *
...
const { fetchApiLocales, fetchApiDictionary, mergeApiLocales, withApiDictionary } =
    await import('@/infrastructure/i18n/apiDictionary.ts');
const { API_NAMESPACE, supportedLanguages } = await import('@/infrastructure/i18n');
