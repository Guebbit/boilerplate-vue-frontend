/**
 * `scripts/backendPath.ts` — where both halves of the pairing look for the other repo.
 *
...
import { DEFAULT_BACKEND_PATH, resolveBackendPath } from '../../../scripts/backendPath';
