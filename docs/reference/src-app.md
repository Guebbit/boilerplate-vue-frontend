...
| `src/app/components/AppNavigation.vue` | The app shell's navigation bar, built from the registry's navigation entries rather than a hand-written list. | [Sitemap & Access Control](../theory/sitemap.md) |
