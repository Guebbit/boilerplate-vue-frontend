...
- **Single observability store**: [Grafana Faro and Umami](../tools/observability.md) are wired together in `src/infrastructure/observability.ts`; no vendor calls leak into components.
