...
export default defineConfigWithVueTs(
    ...
    globalIgnores([
        ...
        '.stryker-tmp/**',
        /*
         * Claude Code's scratch directory, which holds git WORKTREES — whole copies of this
         * project, sitting outside the `tsconfig` project `parserOptions.project` resolves
         * against. Same failure as `.stryker-tmp/**` above and the same fix: without it, every
         * typed rule throws the moment a worktree exists, and `npm run lint` fails on a copy of
         * code that is already linted where it lives.
         */
        '.claude/**',
        /*
