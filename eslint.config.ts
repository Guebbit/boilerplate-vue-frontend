...
export default defineConfigWithVueTs(
    ...
    globalIgnores([
        ...
        /*
         * Generated by `npm run gen:asyncapi`, alongside the mock output above — and shared
     ...
     * (eslint-plugin-oxlint used to sit here, switching OFF every rule oxlint covers — but no
     * oxlint binary was installed or invoked, so those rules were checked by nobody.)
     */
