...
export const ExportAccountDataResponse = zod.strictObject({
  ...
  "reference": zod.string().describe('The order\'s own id — what the customer writes in the transfer\'s description, so an incoming payment can be matched back to this order.')
}).optional(),
