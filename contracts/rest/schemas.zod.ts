                    ...
                    zod.strictObject({
                        product: zod.strictObject({
                            ...
                            weight: zod
                                .number()
                                .min(
                                    exportAccountDataResponseDataOrdersItemItemsItemProductWeightMin
                                )
                                .optional(),
        ...
        items: zod.array(
            zod.strictObject({
                product: zod.strictObject({
                    ...
                    weight: zod
                        .number()
                        .min(updateOrderResponseDataItemsItemProductWeightMin)
                        .optional(),
                    categories: zod.array(zod.string()).optional(),
                    tags: zod.array(zod.string()).optional(),
                    createdAt: zod.iso.datetime({ offset: true }).optional(),
        ...
        taxSummary: zod
            .array(
                zod.strictObject({
                    rate: zod
                        .number()
                        .min(updateOrderResponseDataTaxSummaryItemRateMin)
                        .describe(
                            'The decimal rate this row is for (`0.22` for 22%) — never repeated across rows.'
                        ),
                    ...
                    grossAmount: zod
                        .number()
                        .min(updateOrderResponseDataTaxSummaryItemGrossAmountMin)
                        .describe('`netAmount + taxAmount`, not re-derived from a price.')
                })
            )
            .optional()
