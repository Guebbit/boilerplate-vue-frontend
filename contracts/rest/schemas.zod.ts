...
export const ExportAccountDataResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(exportAccountDataResponseDataOrdersItemNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const CheckoutResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(checkoutResponseDataOrderNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const ListOrdersResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(listOrdersResponseDataItemsItemNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const CreateOrderResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(createOrderResponseDataNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const UpdateOrderResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(updateOrderResponseDataNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const SearchOrdersResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(searchOrdersResponseDataItemsItemNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const GetOrderByIdResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(getOrderByIdResponseDataNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const UpdateOrderByIdResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(updateOrderByIdResponseDataNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const CancelOrderByIdResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(cancelOrderByIdResponseDataNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const OverrideOrderStatusResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(overrideOrderStatusResponseDataNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
...
export const GetOrderByReferenceResponse = zod.strictObject({
  ...
  "netTotal": zod.number().min(getOrderByReferenceResponseDataNetTotalMin).optional().describe('Sum of every line\'s `netAmount` — the goods total excluding VAT. Absent on a pre-VAT order.'),
