 ...
 * strips scheme/host and query string, guarantees a leading slash. A leaf both
 * `response-schema-map.ts` (route patterns) and `refresh.ts` (the exclusion set) read, so the two
 * cannot recognise different sets of URLs.
 */
