/**
 * @module
 * Pins the `meta.access` every webhooks route declares, checked by name via a lookup helper
 * against the module's own route records rather than a resolved router — needs neither the
 * locale prefix nor the rest of the app.
 *
